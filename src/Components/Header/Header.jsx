      ...
      <div className="container mx-auto flex justify-between items-center px-4 py-3">
        ...
        <ul className="flex items-center gap-2 lg:gap-6 text-sm">
          ...
          <li className="flex items-center">
            ...
            <NavLink className="text-xs lg:text-sm text-white bg-purple-600 hover:bg-transparent hover:text-purple-600 border border-purple-600 py-1 px-3 lg:py-2 lg:px-4 ml-2 lg:ml-4 transition-all max-sm:hidden" to="/button">
              {t('header.header_5')}
            </NavLink>
          </li>
        </ul>
